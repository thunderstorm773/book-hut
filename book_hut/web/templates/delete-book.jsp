                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <input type="text" class="form-control" name="title" id="title"
                                   value="<c:out value="${book_info.title}"/>" placeholder="Title" disabled/>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <input type="text" class="form-control" name="author" id="author"
                                   value="<c:out value="${book_info.author}"/>" placeholder="Author" disabled/>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <input type="number" class="form-control" name="pages" id="pages" min="1"
                                   value="<c:out value="${book_info.pages}"/>" placeholder="Pages" disabled/>
                        </div>
                    </div>
                    <div class="form-group">
